<div class="fs-3 display-1 d-flex flex-column justify-content-center align-items-center">
    <h2 class="fw-light">Dental</h2>
    <hr class="border w-25 m-0 border-dark">
</div>
...
<div class="fs-3 fw-bold d-flex flex-column justify-content-center align-items-center">
    <h2 class="fw-light">Optical</h2>
    <hr class="border w-25 m-0 border-dark">
</div>
<div class="container-fluid py-2">
    <div class="card p-3 z-1 bg-primary shadow-sm">
